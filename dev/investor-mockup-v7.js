(function () {
  ...
  function findAnswer(query) {
    ...
    if (/^(hi|hello|hey|good morning|good afternoon)/.test(text)) {
      return {
        answer:
          "Hello. You can ask about fees, performance fee rules, inception date, benchmark, custodian, documents, and contact details.",
        html: false,
      };
    }
    ...
    return {
      answer:
        "I do not have that answer yet. Try asking about performance fee, management fee, inception date, benchmark, PDS, TMD, or custodian.",
      html: false,
    };
  }
